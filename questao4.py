...
class ListaEncadeada:
    ...
    def remover_duplicidades(self):
        ...
        while no_atual is not None:
            if no_atual.valor in encontrados:
                # Remove o nó duplicado
                no_anterior.proximo = no_atual.proximo
                self._quantidade -= 1
            else:
                encontrados.add(no_atual.valor)
    ...
    def maiores_que(self, valor):
        ...
        while no_atual is not None:
            if no_atual.valor > valor:
                nova_lista.inserir(len(nova_lista), no_atual.valor)
            no_atual = no_atual.proximo
    ...
    def map(self, func):
        ...
        while no_atual is not None:
            novo_valor = func(no_atual.valor)
            nova_lista.inserir(len(nova_lista), novo_valor)
            no_atual = no_atual.proximo
...
#----------------------------------------------------------questao 2--------------------------------------------------------------
# Testando o método remover_duplicidades

# Criando uma lista com duplicidades
lista = ListaEncadeada()
lista.inserir(0, 1)
lista.inserir(1, 2)
lista.inserir(2, 2)
...
print("Lista antes de remover duplicidades:", lista)
lista.remover_duplicidades()
print("Lista após remover duplicidades:", lista)


#----------------------------------------------------------questao 3--------------------------------------------------------------

# Testando o método maiores_que
...
# Testando o método maiores_que
nova_lista = lista.maiores_que(3)
print("Elementos maiores que 3:", nova_lista)


#----------------------------------------------------------questao 4--------------------------------------------------------------

# Testando o método map
nova_lista = lista.map(transformar)
print("Lista após aplicar map com transformar(x) = x * 2:", nova_lista)
